...
import com.smartplace.json_tutorial.data.chespiritoArray;
import com.smartplace.json_tutorial.data.NamesArray;


public class MainActivity extends Activity {

    //public static NamesArray mNamesArray;
    public static chespiritoArray mNamesArray;
    public NameListAdapter mNameListAdapter;
        ...
        public void handleMessage(Message msg) {
            ...
            if ((response.equals("")) || response.equals("no connection")) {
                ...
                try {
                    ...
                    mNamesArray = new Gson().fromJson(response, chespiritoArray.class);
                    mNameListAdapter = new NameListAdapter(getBaseContext(),mNamesArray.getNamesActores());
