...
import com.smartplace.json_tutorial.data.chespirito;
...
public class NameListAdapter extends BaseAdapter{
    ...
    private ArrayList<chespirito> mNamesArray;
    //private ArrayList<Names> mNamesArray;

    public NameListAdapter(Context context, ArrayList<chespirito> namesList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.textView.setText(mNamesArray.get(i).getActor());
